...
<script type="text/javascript">
     ...
     export default {
          ...
          computed: {
               formTitle () {
                    return this.editIndexObj === -1 ? 'Nuevo Servicio' : 'Editar Servicio'
               },
               titleCrud(){
          ...
          methods: {
               ...
               getServices(){
                    this.$Progress.start()
                    axios.get(this.$apiUrl + `/services` ).then(response => {
               ...
               saveObject () {
                    ...
                    axios.post(this.$apiUrl + `/services`, this.editarObj).then(response => {
                         if (response.status == 200) {
                              this.infoCrud = 'Guardado Exitosamente'
                              this.snackbarInfoCrud = true
                              this.services.unshift(response.data.producto)
                              this.getServices()
                              this.close()
                              this.$Progress.finish()
                         }
               ...
               editObj (item) {
                    this.editMode = true
                    this.editIndexObj = this.services.indexOf(item)
               ...
               updateObject () {
                    ...
                    axios.put(this.$apiUrl + `/services/` + this.editarObj.id, this.editarObj).then(response => {
                         if (response.status == 200) {
               ...
               deleteItemConfirm () {
                    ...
                    axios.post(this.$apiUrl + `/services-trash/` + this.editarObj.id).then(response => {
                         if (response.status == 200) {
